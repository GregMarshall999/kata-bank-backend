...
public interface BankUserMapper {
     ...
     */
    static BankUser fromDomain(BankUserAccount account) {
        return new BankUser(
                account.getId(),
                account.getName(),
                account.getSurname(),
     ...
     */
    static BankUserAccount toDomain(BankUser user) {
     ...
     */
    static List<BankUserAccount> toDomain(List<BankUser> users) {
